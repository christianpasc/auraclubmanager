-- ============================================
-- Migration Fix: Add missing columns + recreate RPCs with ALL parameters
-- Including: max_users, max_athletes, features_school, features_club
-- Execute this in the Supabase SQL Editor
-- ============================================

-- 1. Add missing columns to stripe_plans (safe - IF NOT EXISTS)
...
-- ============================================
-- 2. Recreate admin_create_plan with ALL parameters
-- ============================================
...
-- ============================================
-- 3. Recreate admin_update_plan with ALL parameters
-- Note: p_max_users / p_max_athletes use sentinel -1 = "not provided, keep existing"
-- ============================================
...
BEGIN
  ...
  UPDATE public.stripe_plans SET
    ...
    -- -1 = sentinel "not provided", NULL = explicitly set to unlimited
...
-- ============================================
-- 4. Create (or replace) check_plan_limits RPC
-- ============================================
...
-- ============================================
-- Done! All RPCs updated with full parameter list.
-- ============================================
